...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var sumString = `${a} and ${b} and ${c} sum to ${sumAll[0]}.`;
  var productString = `The product of ${a} and ${b} and ${c} is ${productAll[0]}.`;
...
function sumArray(sumArr) { //eslint-disable-line
  let total = sum((sum(sumArr[0],sumArr[1])[0]), sumArr[2])[0];
...
function multiplyArray(multArr) { //eslint-disable-line
  var total = multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0];
  let outputString = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${total}.`
  return [total, outputString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  let outputString = `The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of ${total}.`
  return [total, outputString];
}
